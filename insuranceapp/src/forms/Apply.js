...
const Apply = (props) => {
    ...
    return(
        <div className="container">
          <h2 className="applyh2">Application</h2>
    ...
    return(
          ...
          <h2 className="applyh2">Application</h2>
            ...
            <div className="form-group">
                <input 
                  ...
                  value={id}
                  onClick={(e) => setid(user.id)}
                  placeholder="click to userid id"
                    />
            </div>
            <br></br>
        ...
        <div className="form-group">
            ...
            <div class="form-group col-md-8">
                      <label>choose alcoholic status</label>
                        <select className="form-control col-4"
                            type="submit"
                            id="alcoholic"
                            value={alcoholic}
                            ...
                            placeholder="select user type from dropdown">
                            <option value="?">Alchoholic?</option>
            ...
            <br></br>
            <div class="form-group col-md-8">
                      <label>choose tobacco status</label>
                        <select className="form-control col-4"
                            type="submit"
                            id="tobbaco"
                            value={tobbaco}
                            onChange={(e) => setTobbaco(e.target.value)}
                            placeholder="select user type from dropdown">
